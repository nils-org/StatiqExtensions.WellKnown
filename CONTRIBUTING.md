# Contributing to StatiqExtensions.WellKnown

First and foremost, thank you! We appreciate that you want to contribute to StatiqExtensions.WellKnown,
...
**Showing support for StatiqExtensions.WellKnown**  
...
Don't have time to contribute? No worries, here are some other ways to show your support for StatiqExtensions.WellKnown:

- star the [project][]
- tweet your support for StatiqExtensions.WellKnown
...
- **version**: (required) please note the version of StatiqExtensions.WellKnown you are using
...
- **addins, etc**: (if applicable) please list any other addins you're using that may affect the StatiqExtensions.WellKnown addin

### Closing issues

The original poster or the maintainers of StatiqExtensions.WellKnown may close an issue at any time.
Typically, but not exclusively, issues are closed when:

- The issue is resolved, and will be released in the next version of StatiqExtensions.WellKnown
...
[project]: https://github.com/nils-org/StatiqExtensions.WellKnown
